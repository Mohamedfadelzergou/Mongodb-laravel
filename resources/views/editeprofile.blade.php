                ...
                <div class="navbar">
                    <div class="nav-item d-none d-sm-block">
                        <div class="header-logo">
                            <a href="index.html"><img src="{{asset('media/logo.png')}}" alt="Cirkle"></a>
                        </div>
                    </div>
                            ...
                            <div class="dropdown dropdown-cart">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <div class="item-body">
                                        <div class="media">
                                            <div class="item-img">
                                                <img src="{{asset('media/figure/cart_1.jpg')}}" alt="Product">
                                            </div>
                                        ...
                                        <div class="media">
                                            <div class="item-img">
                                                <img src="{{asset('media/figure/cart_2.jpg')}}" alt="Product">
                                            </div>
                                            <div class="media-body">
                                        ...
                                        <div class="media">
                                            <div class="item-img">
                                                <img src="{{asset('media/figure/cart_3.jpg')}}" alt="Product">
                                            </div>
                                            <div class="media-body">
                            ...
                            <div class="dropdown dropdown-friend">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <div class="item-body">
                                        <div class="media">
                                            <div class="item-img">
                                                <img src="{{asset('media/figure/chat_5.jpg')}}" alt="Notify">
                                        ...
                                        <div class="media">
                                            <div class="item-img">
                                                <img src="{{asset('media/figure/chat_1.jpg')}}" alt="Notify">
                                        ...
                                        <div class="media">
                                            <div class="item-img">
                                                <img src="{{asset('media/figure/chat_8.jpg')}}" alt="Notify">
                                                <span class="chat-status online"></span>
                                            </div>
                                            <div class="media-body">
                            ...
                            <div class="dropdown dropdown-message">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <div class="item-body">
                                        <a href="#" class="media">
                                            <div class="item-img">
                                                <img src="{{asset('media/figure/notifiy_1.png')}}" alt="Notify">
                                            </div>
                                            <div class="media-body">
                                        ...
                                        <a href="#" class="media">
                                            <div class="item-img">
                                                <img src="{{asset('media/figure/notifiy_2.png')}}" alt="Notify">
                                            </div>
                                            <div class="media-body">
                                        ...
                                        <a href="#" class="media">
                                            <div class="item-img">
                                                <img src="{{asset('media/figure/notifiy_3.png')}}" alt="Notify">
                                            </div>
                                            <div class="media-body">
                ...
                <div class="sidebar-menu-wrap">
                    <div class="mCustomScrollbar" data-mcs-theme="dark" data-mcs-axis="y">
                        <ul class="user-chat-list">
                            ...
                            <li class="chat-item chat-open">
                                <div class="author-img">
                                    <img src="{{asset('media/figure/chat_6.jpg')}}" alt="chat">
                                    <span class="chat-status online"></span>
                                </div>
                            </li>
                            <li class="chat-item chat-open">
                                <div class="author-img">
                                    <img src="{{asset('media/figure/chat_7.jpg')}}" alt="chat">
                                    <span class="chat-status offline"></span>
                                </div>
                            </li>
                            <li class="chat-item chat-open">
                                <div class="author-img">
                                    <img src="{{asset('media/figure/chat_8.jpg')}}" alt="chat">
                                    <span class="chat-status offline"></span>
                                </div>
                            </li>
                            <li class="chat-item chat-open">
                                <div class="author-img">
                                    <img src="{{asset('media/figure/chat_9.jpg')}}" alt="chat">
                                    <span class="chat-status offline"></span>
                                </div>
                            </li>
                            <li class="chat-item chat-open">
                                <div class="author-img">
                                    <img src="{{asset('media/figure/chat_10.jpg')}}" alt="chat">
                                    <span class="chat-status offline"></span>
                                </div>
                            </li>
                        </ul>
                    ...
                    <div class="col-lg-4 widget-block widget-break-lg">
                        ...
                        <div class="widget widget-memebers">
                            ...
                            <div class="see-all-btn">
                                <a href="#" class="item-btn">See All Friends</a>
                            </div>
                        </div>
